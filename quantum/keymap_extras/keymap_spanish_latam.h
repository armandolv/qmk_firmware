...
#define ES_O    KC_O    // O
#define ES_P    KC_P    // P
// #define ES_GRV  KC_LBRC // ` (dead)    latam ´
...
// #define ES_ACUT KC_QUOT // ´ (dead)   latam {
// #define ES_CCED KC_NUHS // Ç        latam }
...
// #define ES_IQUE S(ES_IEXL) // ¿   latam ¡
#define ES_IEXL S(KC_EQL) // ¡


// Row 2
// #define ES_CIRC S(ES_GRV)  // ^ (dead)  latam ¨
#define ES_DIAE S(ES_ACUT) // ¨ (dead)
#define ES_ASTR S(ES_PLUS) // *

// Row 3
// #define ES_DIAE S(ES_ACUT) // ¨ (dead)   latam [
#define ES_LBRC S(KC_QUOT) // [
#define ES_RBRC S(KC_BSLS) // ]
 ...
 */
// Row 1
// #define ES_BSLS ALGR(ES_MORD) // (backslash)   latam ¬
#define ES_NOT  ALGR(ES_PIPE)    // ¬
// #define ES_PIPE ALGR(ES_1)    // |
// #define ES_AT   ALGR(ES_2)    // @
// #define ES_HASH ALGR(ES_3)    // #    latam  ·
#define ES_BULT ALGR(ES_3)    // ·
// #define ES_TILD ALGR(ES_4)    // ~
#define ES_BSLS ALGR(ES_QUOT) // (backslash)

// Row 2
// #define ES_LBRC ALGR(ES_GRV)  // [     latam ¨
// #define ES_RBRC ALGR(ES_PLUS) // ]     latam ~
#define ES_AT   ALGR(ES_Q)    // @
#define ES_EURO ALGR(ES_E)    // €    latam  ½
#define ES_TILD ALGR(ES_PLUS)    // ~


// Row 3
// #define ES_LCBR ALGR(ES_ACUT) // {    latam ^
// #define ES_RCBR ALGR(ES_CCED) // }    latam `
#define ES_CIRC ALGR(KC_QUOT)  // ^ (dead)
#define ES_GRV  ALGR(KC_NUHS) // ` (dead)
